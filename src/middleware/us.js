        ...
        fetch("/usersidebar")
          ...
          .then((sidebarHTML) => {
            ...
            if (window.location.hash === "") {
              ...
              if (nosotros) {
                nosotros.style.backgroundColor = "#6F4E37";
                nosotros.style.color = "#f9f4e8";
                nosotros.style.borderBottom = "3px solid #6F4E37";
                nosotros.style.borderTop = "3px solid #6F4E37";
                nosotros.style.borderRight = "6px solid #f9f4e8";
                nosotros.style.height = "39px";
              }
            }
            MostrarCategorias();
          });
